  ...
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 sm:mb-12 text-white px-4">Birthday Chat</h2>

        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden flex flex-col h-80 sm:h-96 border border-pink-300/30 mx-4">
          {/* Header */}
          <div className="bg-gradient-to-r from-pink-600 to-red-600 text-white p-3 sm:p-4 flex justify-between items-center">
            <h3 className="font-semibold text-sm sm:text-base">Live Chat</h3>
            <span className="text-xs sm:text-sm">Online: {onlineUsers}</span>
          </div>
